...
public class Modus {
    ...
    public Modus(PApplet p) {
        ...
        rad = 50;
        snake = p.loadImage("assets/Snake.png");
    ...
    /**
     * Fenster f�r Arcademodus anzeigen
     */
    public void arcade() {
        basis();
        timer();
    ...
    /**
     * Fenster f�r Zweispielermodis anzeigen
     */
    ...
    private void basis() {
        p.rectMode(0);
        snake = p.loadImage("assets/SnakeSmall.png");
    ...
    /**
     * Fenster f�r das Ende des Arcademoduses anzeigen
     */
    ...
    /**
     * Fenster f�r das Ende des Zweispielermodi anzeigen
     */
